...
export function SeatSelector({ eventId, seats, userId, token }: SeatSelectorProps) {
  ...
  return (
    <div>
      ...
      {error && (
        <div className="mb-8 text-center">
          <div className="inline-block bg-red-100 text-red-800 px-4 py-2 rounded-lg">{error}</div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="bg-gray-100 p-6 rounded-lg">
            <div className="w-full bg-gray-300 h-8 mb-8 text-center text-gray-700 font-bold">ESCENARIO</div>
                    ...
                    return (
                      <button
                        ...
                        className={`
                          ...
                          ${seat.status === "available" && !isSelected ? "bg-green-100 text-green-800 hover:bg-green-200" : ""}
                          ${seat.status === "reserved" || seat.status === "sold" ? "bg-gray-200 text-gray-400 cursor-not-allowed" : ""}
          ...
          <Card>
            ...
            <CardContent>
              {selectedSeats.length > 0 ? (
                ...
                <p className="text-gray-500 text-center">Selecciona asientos para continuar</p>
              )}
            </CardContent>
            <CardFooter>
              <Button
