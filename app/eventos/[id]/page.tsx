...
export default async function EventoDetallePage({ params }: { params: { id: string } }) {
  ...
  const actors = await getEventActors(params.id)
            ...
            <CardContent className="p-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700">
                  ...
                  <span
                    className={`${event.status === "upcoming" ? "text-blue-600" : event.status === "active" ? "text-green-600" : "text-gray-600"}`}
                  >
              ...
              <JoinQueueButton eventId={event.id} isQueueActive={isQueueActive} saleStartTime={event.sale_start_time} />
            </CardContent>
          </Card>
